      ...
      <Table responsive>
        <tbody>
          <tr>
            <td>
              <Card border="light">
                <Card.Header>Liveness Test Data</Card.Header>
                <Card.Body>
                  <Container>
                    <Row>
                      <Table responsive>
            ...
            <td>
              <Card border="light">
                <Card.Header>Data Extracted from ID documents.</Card.Header>
                <Card.Body>
                  <Container>
                    <Row>
                      <Table responsive>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <img
                                alt="User from Document"
                                src={`${documentDetails["userImage"]}`}
                              />
                            </td>
                          </tr>
                        </tbody>
          ...
          <tr>
            <td colSpan="2">
              <Card>
                <Card.Header>Compare Faces to complete KYC</Card.Header>
                <Card.Body>
                  {faceSimilarity === -1 && (
                    <Button variant="primary" onClick={compareFaces}>
                      Compare Faces
                    </Button>
                  )}
                  ...
                  {faceSimilarity !== -1 && (
                    <span>
                      Face Similarity is{" "}
                      <b> {Math.round(faceSimilarity, -2)}% </b>
                    </span>
                  )}
